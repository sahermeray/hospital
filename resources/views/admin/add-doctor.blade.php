    ...
    <section class="section dashboard">
        <form method="post" action="{{route('add_doctor')}}" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                ...
                <input name="phone" type="text" class="form-control" id="exampleInputPassword1" placeholder="Ente phone">
                @error('phone')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            <div class="form-group mb-2">
                ...
                <input name="room" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter room">
                @error('room')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
